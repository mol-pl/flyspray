...
{    
	...
	function getDokuWikiToolbar( $textareaId ) {
		...
		//
		return '
			<script type="text/javascript" src="'.$baseurl.'plugins/dokuwiki/lib/bar_enhance.js"></script>
			<script type="text/javascript" src="'.$baseurl.'plugins/dokuwiki/lib/bar_enhance.config.js"></script>
