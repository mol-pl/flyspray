...
<html xmlns="http://www.w3.org/1999/xhtml" lang="{L('locale')}" xml:lang="{L('locale')}">
  <head>
	...
	<script src="{$baseurl}javascript/jquery-ext.js?1210"></script>
    <link href="{$baseurl}javascript/jquery-ext.css?1210" rel="stylesheet" media="screen" />
    ...
    <script type="text/javascript" src="{$baseurl}javascript/functions.js?1224"></script>
