<div id="toolbox">
  ...
  <div id="general" class="tab">
      <div style="float:left">
		  <table class="box prefs_box">
			<tr>
			  <td class="first_cell"><label for="projecttitle">{L('projecttitle')}</label></td>
			  <td>
      ...
      <div style="float:left">
		  <table class="box prefs_box">
			<tr>
			  <td class="first_cell"><label for="isactive">{L('isactive')}</label></td>
			...
			<tr>
			  ...
			  <td><select name="move_to">{!tpl_options(array_merge(array(0 => L('none')), Flyspray::listProjects()), null, false, null, (string) $proj->id)}</select></td>
			</tr>
		  </table>
	  </div>
      <div style="clear:both">
        <div>
			<label for="intromesg">{L('intromessage')}</label><br />
        ...
        <div>
			<label for="default_task">{L('defaulttask')}</label><br />
            <?php if (defined('FLYSPRAY_HAS_PREVIEW')): ?>
